...
<div class="form-container">
   ...
   <form action="" method="post">
      <h3>register now</h3>
      <input type="text" name="name" placeholder="inserisci il tuo nome" required class="box">
      ...
      <input type="password" name="cpassword" placeholder="conferma la tua password" required class="box">
      <select name="user_type" class="box">
         <option value="user">User</option>
         <option value="admin">Admin</option>
      </select>
      <input type="submit" name="submit" value="Registrati ora" class="btn">
