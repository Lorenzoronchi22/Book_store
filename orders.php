...
<div class="heading">
   <h3>your orders</h3>
   <p> <a href="home.php">Home</a> / Ordini </p>
</div>

<section class="placed-orders">

   <h1 class="title">Ordini effetuati</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> I tuoi ordini : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         <p> Totale prezzo : <span>$<?php echo $fetch_orders['total_price']; ?>/-</span> </p>
         </div>
      <?php
       }
      }else{
         echo '<p class="empty">Nessun ordine già effetuato!</p>';
      }
      ?>
   </div>
