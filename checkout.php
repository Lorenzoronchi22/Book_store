...
if(isset($_POST['order_btn'])){
   ...
   $order_query = mysqli_query($conn, "SELECT * FROM `orders` WHERE name = '$name' AND number = '$number' AND email = '$email' AND method = '$method' AND address = '$address' AND total_products = '$total_products' AND total_price = '$cart_total'") or die('query 2 failed');

   if($cart_total == 0){
      $message[] = 'Il tuo carrello è pieno';
   }else{
...
<section class="display-order">
   ...
   ?>
   <div class="grand-total"> Totale : <span>$<?php echo $grand_total; ?>/-</span> </div>
...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Numero :</span>
            <input type="number" name="number" required placeholder="Inserisci il tuo numero">
         </div>
         <div class="inputBox">
            <span>Email :</span>
      ...
      <input type="submit" value="Ordina" class="btn" name="order_btn">
   </form>
